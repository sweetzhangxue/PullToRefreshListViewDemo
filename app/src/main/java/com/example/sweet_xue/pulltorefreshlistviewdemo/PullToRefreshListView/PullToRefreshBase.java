...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	 ...
	 * @param state
	 */
	public void setFootViewTextState(int state) {
		switch (state){
			case STATE_DEFAULT:
				onRefreshComplete();
				break;
			case STATE_SUCCESS:
				mFooterLayout.setTextState(STATE_SUCCESS);
				...
				break;
			case STATE_FAIL:
				mFooterLayout.setTextState(STATE_FAIL);
				handler.postDelayed(new Runnable() {
					@Override
					public void run() {
						onRefreshComplete();
				...
				break;
			case STATE_DONE:
				mFooterLayout.setTextState(STATE_DONE);
				handler.postDelayed(new Runnable() {
					@Override
					public void run() {
						onRefreshComplete();
