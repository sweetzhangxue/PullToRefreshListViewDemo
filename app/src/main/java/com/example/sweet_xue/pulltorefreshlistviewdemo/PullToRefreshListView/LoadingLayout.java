...
import com.example.sweet_xue.pulltorefreshlistviewdemo.R;

/**
 * Created by zlp on 2015/12/1.
 */
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    public final void setTextState(int state){
        ...
        mHeaderImage.setVisibility(View.INVISIBLE);
        switch (state){
            case PullToRefreshBase.STATE_SUCCESS:
                mHeaderText.setText(getContext().getString(R.string.load_success));
                break;
            case PullToRefreshBase.STATE_FAIL:
                mHeaderText.setText(getContext().getString(R.string.load_fail));
                break;
            case PullToRefreshBase.STATE_DONE:
                mHeaderText.setText(getContext().getString(R.string.load_done));
                break;
        }
